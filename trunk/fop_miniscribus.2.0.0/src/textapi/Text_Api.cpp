...
QColor TextProcessor::HightlightColor() const
{
...
void ScribePage::paintStyle( QPainter * painter , const QRectF rect , bool print )
{
    
    const QColor pageground = PAGE_MODEL.body.bg;  /* background color */
    ////////////currentP.body.margin_left,currentP.body.margin_top
    QRectF internalrect(  rect.left() + PAGE_MODEL.body.margin_left  ,rect.top() + PAGE_MODEL.body.margin_top ,PAGE_MODEL.width(),PAGE_MODEL.height());
    ...
    /*  body internal background color and style  */
    QPen pagebodypen(PAGE_MODEL.body.rpen);
    pagebodypen.setBrush(PAGE_MODEL.body.bog);
    painter->setPen(pagebodypen);
    painter->setBrush(pageground);
...
void ScribePage::paintMarginCover( QPainter * painter , const QRectF rect , bool print )
{
    painter->save();
