...
void MountTextPrivate::edit( bool e)
{
	edit_enable = e;
...
void MountTextPrivate::setxhtml( QString html )
{
	if (html.size() < 2) {
	return;
	}
...
void MountTextPrivate::setDocument(QTextDocument *document)
{
	if (_d == document) {
	return;
	}
...
void MountTextPrivate::blockCount( int bb )
{
...
void MountTextPrivate::cursorPosition( const QTextCursor curs )
{
...
QRectF MountTextPrivate::cursorRect(const QTextCursor &cursor)
{
    if (cursor.isNull()) {
        return QRectF();
		}
...
QRectF MountTextPrivate::Rect2cursorpoint( const QTextCursor &cursor  , const int first , const int second ) 
{
...
int  MountTextPrivate::LinefromPosition(int position)
{
	              QTextCursor neon(_d);
...
QRectF MountTextPrivate::rectForPosition(int position)
{
		QTextCursor neon(_d);
	              neon.setPosition(position);
...
QTextLine MountTextPrivate::TextLineAt(int position)
{
	QTextCursor neon(_d);
...
void MountTextPrivate::wake_up( const int msec )
{
	 _d->adjustSize();
	 QTimer::singleShot(msec,this,SLOT(update())); 
}

void MountTextPrivate::update()
{
	_d->adjustSize();
	lastrect = boundingRect();
}

QRectF MountTextPrivate::boundingRect() const
{
	if (_d) {
	_d->adjustSize();
...
void MountTextPrivate::repaintCursor( bool allrect )
{
...
int MountTextPrivate::hitTest(const QPointF &point, Qt::HitTestAccuracy accuracy) const
{
    return _d->documentLayout()->hitTest(point, accuracy);
}

QTextLine MountTextPrivate::currentTextLine(const QTextCursor &cursor)
{
...
void MountTextPrivate::procesevent( QEvent *e )
{
	  QMatrix matrix;
...
void MountTextPrivate::tmouseDoubleClickEvent(QEvent *e, Qt::MouseButton button, const QPointF &pos)
{
...
void MountTextPrivate::ClearSelections()
{
...
void MountTextPrivate::selectionChanged(bool forceEmitSelectionChanged /*=false*/)
{
...
void MountTextPrivate::timerEvent(QTimerEvent *event)
{
...
void MountTextPrivate::tkeyPressEvent(QKeyEvent *e)
{
	  if(!_d) {
		return;
		}
...
bool MountTextPrivate::cursorMoveKeyEvent(QKeyEvent *e)
{
...
void MountTextPrivate::setCursorPosition(const QPointF &pos)
{
...
QTextCursor MountTextPrivate::_cForPosition()
{
	if (Cursor_From_Event_Source) {
		return C_cursor;
	}
...
void MountTextPrivate::UpadateCursor( const int freezeon )
{
...
void MountTextPrivate::GrepCursorData()
{
	if (!editable()) {
	return;
	}
...
void MountTextPrivate::setClipboardSelection()
{
...
void MountTextPrivate::insertFromMimeData(const QMimeData *source)
{
