...
REM get http://www.winkde.org/pub/kde/ports/win32/releases/unstable/4.0.83/iconv-1.9.2-2-lib.zip
REM rename  iconv.lib  to libiconv.lib  to respect other compiler   dll on relative bin
