...
void ConnectionWidget::MysincrosStart()
{
    ////////QMessageBox::information(this, tr("Errore"),tr("da ConnectionWidget ciao "));
    ////Sincro::self( this )->show();
     //////Gui_Main_Final::self()->show();
}
